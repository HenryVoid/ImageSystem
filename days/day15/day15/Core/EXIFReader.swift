...
class EXIFReader {
    ...
    /// PHAsset에서 EXIF 데이터 로드 (비동기)
    static func loadEXIFData(from asset: PHAsset, completion: @escaping (EXIFData?) -> Void) {
        ...
        PHImageManager.default().requestImageDataAndOrientation(
            ...
            let exifData = loadEXIFData(from: data)
            completion(exifData)
        }
    }
